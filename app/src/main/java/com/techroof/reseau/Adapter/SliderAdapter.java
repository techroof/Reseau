package com.techroof.reseau.Adapter;
...
public class SliderAdapter extends SliderViewAdapter<SliderAdapter.SliderAdapterVH> {
    ...
    private ArrayList<Images> mSliderItems;

    public SliderAdapter(Context context, ArrayList<Images> mSliderItems) {
 ...
 */
    ...
    public void onBindViewHolder(SliderAdapterVH viewHolder, final int position) {
        ...
        Images images = mSliderItems.get(position);
