...
public class CreatorNewsfeedAdapter extends RecyclerView.Adapter<CreatorNewsfeedAdapter.NewsfeedViewHolder> {
    ...
    public CreatorNewsfeedAdapter(Context context, ArrayList<Newsfeed> newsfeedArrayList) {
    ...
    public NewsfeedViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.creator_newsfeeds_layout, parent, false);
    ...
    public static class NewsfeedViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView creatorName, newsfeedText, totalSupportsText, supportsText, commentsText, postTimeText;
