...
public class SuperDealsProductsAdapter extends RecyclerView.Adapter<SuperDealsProductsAdapter.AllProductsViewHolder> {

    private Context context;
    private ArrayList<Products> productsArrayList;

    public SuperDealsProductsAdapter(Context context, ArrayList<Products> productsArrayList) {
    ...
    public AllProductsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.super_deal_products_layout, parent, false);
